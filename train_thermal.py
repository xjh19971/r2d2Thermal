...
db_thermal_satellite_images_train = """ThermalPairDataset(
         MYDATA(thermal_args, thermal_args.datasets_folder, thermal_args.dataset_name, "train"), 
        'RandomScale(256,1024,can_upscale=True)',
        'RandomTilting(0.5), PixelNoise(25)')"""

db_thermal_satellite_images_val = """ThermalPairDataset(
         MYDATA(thermal_args, thermal_args.datasets_folder, thermal_args.dataset_name, "train"), 
        'RandomScale(256,1024,can_upscale=True)',
        'RandomTilting(0.5), PixelNoise(25)')"""

data_sources = dict(
    T_train = db_thermal_satellite_images_train,
    T_val = db_thermal_satellite_images_val
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train-data", type=str, default=list('T_train, T_val'), nargs='+', 
